...
The pre-provisioned dashboards are named `Shig RTC Overview`, `Shig RTC Diagnostics`, and `Shig SFU State`.
...
`Shig SFU State` shows the currently active lobby count and the active peer count per lobby.
